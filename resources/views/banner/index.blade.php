                    ...
                    <div class="row">
                        <div class="col text-end">
                            @if (Request::segment(2) == 'satu')
                                <a href="{{ url('/banner/create/' . $angka) }}" type="button" class="btn-sm btn-primary">
                            ...
                            <tbody>
                                @foreach ($banner as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/banner/' .$angka. '/' . $item->gambar) }}"
                                                alt=" {{ $item->gambar }}" width="200vh">
                                        </td>
                                        <td>{{ $item->status }}</td>
                                        <td>
                                            <a href="{{ url('/banner/edit/' . $item->id . '/' . $angka) }}"
